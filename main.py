...
# Simple function that plots the digit received as list of numbers
...
# Function that returns the center datapoint given a nested list of lists of digits
...
# Generate the matrix decompostition. Now the matrix U contains the PCs of out dataset.
# We can discard as many columns as we want in order to meet the bias-variance dilemma
